...
function PastWeatherCard({
  ...
  const celsius = Math.floor(kelvinToCelsius(temperature));
  const fahrenheit = Math.floor(kelvinToFahrenheit(temperature));
  return (
...
export default PastWeatherCard;
